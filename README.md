...
**["Hello world" FRONT END]** 💰💼 I have  created a React front-end with a Rails back-end and connect them to display a random message the link of the [Rails Back End App](https://github.com/beteland123/hello-rails-back-end)
...
```sh
  cd my-folder
  git clone "https://github.com/beteland123/hello-react-front-end.git"
```
### Install
